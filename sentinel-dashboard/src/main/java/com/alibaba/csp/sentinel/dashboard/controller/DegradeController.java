...
import com.alibaba.csp.sentinel.dashboard.rule.mysql.DynamicRuleMySqlProvider;
import com.alibaba.csp.sentinel.dashboard.rule.mysql.DynamicRuleMySqlPublisher;
...
public class DegradeController {
    ...
    @Autowired
    @Qualifier("degradeRuleMySqlProvider")
    private DynamicRuleMySqlProvider<List<DegradeRuleEntity>> ruleProvider;
    @Autowired
    @Qualifier("degradeRuleMySqlPublisher")
    private DynamicRuleMySqlPublisher<List<DegradeRuleEntity>> rulePublisher;
    ...
    public Result<List<DegradeRuleEntity>> apiQueryMachineRules(String app, String ip, Integer port) {
        ...
        try {
           List<DegradeRuleEntity> rulestemp = sentinelApiClient.fetchDegradeRuleOfMachine(app, ip, port);
